...
// @Component({
//   selector: 'app-modifyvehicles',
//   templateUrl: './modifyvehicles.page.html',
//   styleUrls: ['./modifyvehicles.page.scss'],
// })
// export class modifyVehiclesPage implements OnInit {
//   vehicles: any;
//   EditForm : FormGroup;
//   modifyVehiclesPageSelection:number =0; //if you have a select list
//   modifyVehiclesPageOptions:Array<object>; //if you have a select list
//   nmodifyVehiclesPage:object;
//   rcv: object;
...
//   ngOnInit() {
//     this.data.GetmodifyVehicles().subscribe(res=>
//       {
//         this.vehicles = res;
//       })
...
//     }
//     else {
//       this.nmodifyVehiclesPage = {
//         "CarRegistration":CarRegistration, //selfde as die databasis 
//         "Make": Make, //selfde as die databasis
//         "Model":Model,
//         "TypeDescription":TypeDescription
//       };
//       console.log(this.nmodifyVehiclesPage);
//       this.data.PutVehicle(ID,this.nmodifyVehiclesPage).subscribe(res => {
//         this.rcv = res
